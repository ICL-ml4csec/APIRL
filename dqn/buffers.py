...
class PriorityReplayBuffer:
    def __init__(self, max_capacity=50000, alpha=0.6):
    ...
    def sample(self, batch_size, beta=0.4):
        ...
        return np.array(states), actions, rewards, np.array(next_states), buffer_indices, weights, dones
...
class ReplayBuffer:
    def __init__(self, max_capacity=50000):
        self.buffer = collections.deque(maxlen=max_capacity)
